...
$name = "";
  ...
  if(isset($_POST["btn_update"])){
        ...
        $conn->update($sql, "Genre Updated Successfully");
    ...
    <section>
        <div class="container-fluid" style="overflow: hidden;"> <!-- Prevent scrolling -->
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center mt-2" style="color:maroon;">Edit Genre Details</h5>
                    ...
                    <form method="post">
                        ...
                        <input type="text" style="border-radius: 30px;" placeholder="Enter Genre Name" name="genre_name_txt" id="email" value="<?php echo $name; ?>">
